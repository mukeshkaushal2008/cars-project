...
Lorem ipsum dolor sit amet, con sectetur adipisicing elit, sed do eius  mod tempor incididunt ut.</p>
			...
			<div class="bottom_footer">
				...
				<div class="f_widget divide last">
					...
					<ul class="horizontal">
						<li><a href="#"><img src="<?php echo base_url();?>images/fb_icon.png" alt=""></a></li>
						<li><a href="#"><img src="<?php echo base_url();?>images/twitter_icon.png" alt=""></a></li>
						<li><a href="#"><img src="<?php echo base_url();?>images/in_icon.png" alt=""></a></li>
					</ul>
				</div>
			</div>
