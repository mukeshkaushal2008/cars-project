<div id="content">
			<div class="content">
				<div class="breadcrumbs">
					<a href="#">Home</a>
					<img src="<?php echo base_url();?>images/marker_2.gif" alt=""/>
					<span>Cars</span>
				</div>
				<div class="main_wrapper">
					...
					<div class="main_catalog">
						<div class="top_catalog_box">
							...
							<div class="pagination">
								<ul>
									...
									<li class="space">...</li>
									<li><a href="#">8</a></li>
									<li class="next"><a href="#"><img src="<?php echo base_url();?>images/page_next.gif" alt=""/></a></li>
								</ul>
							</div>
							<div class="clear"></div>
						</div>
						<ul class="catalog_list">
							<li>
								<a href="#">
									<img src="<?php echo base_url();?>images/placeholders/213x164.gif" alt=""/>
