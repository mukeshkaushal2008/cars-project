  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9 col-sm-8 left_side">
        ...
        <div class="blog_one">
          <div class="col-md-12 main_title"><?php echo stripcslashes($value['blog_title']); ?></div>
          <div class="col-md-12 posted">Posted by <span><?php echo $value['posted_by']; ?></span> | <?php echo date('d-F-Y',$value["date_posted"]);?></div>
          <div class="col-md-12 col-sm-12 col-xs-12 about_div blog_page"> <img src="<?php echo $this->config->item('blogimages'); ?><?php echo $value['blog_images']; ?>" alt="" />
            <p><?php echo $string = limit_string($value['blog_content'],490); ?></p>
            <a href="<?php echo base_url() ?>blog/<?php echo $value['slug']; ?>">Read more>></a>
            </p>
          </div>
        </div>
        <?php } ?>
      ...
      </ul><!--<a href="#">Show More All Results</a>--> </div>
      </div>
      <div class="col-md-3 col-sm-4 right_side">
        <div class="col-md-12 col-sm-12 col-xs-12 welcome_div about_right">
          ...
          <a href="#"><img src="<?php echo base_url() ?>images/im2.png" alt="">Chat With Us Now</a> <a href="#">
          <img src="<?php echo base_url() ?>images/im1.png" alt="">Create a Support Case Now</a> </div>
