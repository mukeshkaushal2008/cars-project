...
<input type="hidden" name="end_timestamp" id="end_sec" value="" />
  ...
  <div class="product_det">
   ...
   <!-- <div class="details" ng-show="true">
    <div class="row">
        <div ng-class="productEntry.isLive ?'col-xs-6 col-sm-4 col-md-3':'col-xs-6 col-sm-6 col-md-6'" class="col-xs-6 col-sm-6 col-md-6">
            <div class="titre">Retail</div>
            <div class="value ng-binding strike" ng-class="productEntry.isLive || productEntry.isPaused?'':'strike'" ng-bind="'$ '+ (productEntry.retailPrice | number:2)">$ 1,900.00</div>
        </div>
    </div>
</div>
	<div class="winner ng-scope" ng-if="!productEntry.isLive &amp;&amp; !productEntry.isPassed &amp;&amp; (productEntry.wasManaged || productEntry.isPaused)" ng-show="!productEntry.isLive &amp;&amp; !productEntry.isPassed &amp;&amp; (productEntry.wasManaged || productEntry.isPaused)">
   <div class="ng-scope" ng-show="productEntry.winner != null &amp;&amp; productEntry.winner !=''" ng-if="productEntry.winner != null &amp;&amp; productEntry.winner !=''">WON BY <span class="name ng-binding" ng-bind="productEntry.winner">Sarsoorti</span></div>
    <br>
    <span class="price ng-binding" ng-bind="'$ '+ (productEntry.price | number:2)">$ 151.01</span>
    <span class="saved ng-binding" ng-bind="'$ '+ ((productEntry.retailPrice - productEntry.price) | number:2)+' saved'">$ 1,748.99 saved</span>
</div>-->
    <!--if product time is not expired -->
