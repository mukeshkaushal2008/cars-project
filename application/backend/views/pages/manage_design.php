...
<div class="row">
  <div class="col-md-12"> 
    ...
    <h3 class="page-title"> Design planning </h3>
    <ul class="page-breadcrumb breadcrumb">
      <li> <i class="fa fa-home"></i> <a href="<?php echo base_url();?>"> Home </a> <i class="fa fa-angle-right"></i> </li>
      <li> <a href="javascript:void(0);"> Content Mangement /  Design planning </a> </li>
    </ul>
  ...
  <div class="col-md-12"> 
    ...
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a href="#tab_1_1" data-toggle="tab"> Design planning</a> </li>
      </ul>
        ...
        <div class="tab-pane active" id="tab_1_1">
          <div class="row">
            <div class="col-md-9" style="width:100%">
              ...
              <form name="frm" id="frm" action="<?php echo base_url(); ?><?php echo $this->router->class;?>/update_page_to_database" method="post" enctype="multipart/form-data">
                <?php if($do=="edit"){ ?>
                <input type="hidden" name="id" value="<?php echo !empty($resultset['id']) ? $resultset['id'] : "";?>">
                <input type="hidden" name="page_name" value="<?php echo !empty($resultset['page_name']) ? $resultset['page_name'] : "";?>">
                <?php	} ?>
                <div class="form-group flare">
                  <label class="control-label col-md-2"> Video<span class="required"> * </span> </label>
                  <div class="col-md-8">
                    <input class="form-control"  name="video_id" id="video_id" type="text" value="<?php echo !empty($resultset['video_id']) ? $resultset['video_id'] : "";?>"/>
                  </div>
                </div>
                <div class="form-group flare">
                  <label class="control-label col-md-2" style="width:11.333333%"> Page Content </label>
                  <div class="col-md-8" style="width:87.666667%">
                    <textarea  class="ckeditor"  name="page_content" id="description"><?php echo !empty($resultset['page_content']) ? $resultset['page_content'] : "";?></textarea>
