...
<div class="col-md-12"> 
  ...
  <ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="javascript:void(0);"> Content Mangement / Home content  </a> </li>
  </ul>
        ...
        <div class="row">
          <div class="col-md-9" style="width:100%">
           ...
           <div class="form-group flare">
                ...
                <div class="col-md-8">
                    <input class="form-control"  name="page_title" id="page_title" type="text" value="<?php echo !empty($resultset['page_title']) ? $resultset['page_title'] : ""; ?>"/>
                </div>
            </div>
            ...
            <div class="form-group flare">
                ...
                <div class="col-md-8">
                    <textarea style="min-height:150px" class="form-control" name="page_content" id="page_content"><?php echo !empty($resultset['page_content']) ? $resultset['page_content'] : ""; ?></textarea>
                </div>
            </div>
