...
<div class="col-md-12"> 
  ...
  <ul class="page-breadcrumb breadcrumb">
    ...
    <li> <a href="javascript:void(0);"> Content Management / <?php echo $master_title ?>  </a> </li>
  </ul>
...
<div class="col-md-12"> 
  ...
  <div class="tabbable tabbable-custom tabbable-full-width">
    <ul class="nav nav-tabs">
      <li class="active"> <a href="#tab_1_1" data-toggle="tab">  <?php echo $master_title ?> </a> </li>
    </ul>
      <div class="message2" id="message"> <font color='red'><?php echo $this->session->flashdata('errormsg'); ?></font>
