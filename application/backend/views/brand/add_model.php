...
<div class="row">
    <div class="col-md-12"> 
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li> <a href="javascript:void(0);"> Add model </a> </li>
        </ul>
    ...
    <div class="col-md-12"> 
        ...
        <div class="tabbable tabbable-custom tabbable-full-width">
            <ul class="nav nav-tabs">
                <li class="active"> <a href="#tab_1_1" data-toggle="tab"> Add model </a> </li>
            </ul>
                ...
                <div class="tab-pane active" id="tab_1_1">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <form name="frm" id="validation_brand" action="<?php echo base_url() . $this->router->class; ?>/add_model_to_database" method="post">
                                    ...
                                    <div class="form-group flare">
                                            ...
                                            <div class="col-md-8">
                                              ...
                                              <?php foreach($brands as $k => $v){?>
                                                  <option value="<?php echo $v["id"]?>" <?php if($v["id"] == $modelinfo['brand_id']) {echo 'selected="selected"';}else{echo '';} ?>> <?php echo $v["brand_name"];?></option>
                                                <?php }?>
                                                </select>
                                            </div>
                                          </div>
                                ...
                                <div class="form-group flare">
                                    <label class="control-label col-md-4"> Model name<span class="required"> * </span> </label>
                                    <div class="col-md-8">
                                        <input class="form-control"  name="model_name" id="brand_name" type="text" value="<?php echo !empty($modelinfo['model_name']) ? $modelinfo['model_name'] : ""; ?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <a href="<?php echo base_url() . $this->router->class; ?>/manage_model"  class="btn theme-btn grey pull-left margd">Cancel</a> </div>
                                </div>
                            </form>
                        </div>
                    </div>
