...
<div class="row">
  <div class="col-md-12"> 
    ...
    <ul class="page-breadcrumb breadcrumb">
      <li class="btn-group"> <a href="<?php echo base_url() . $this->router->class ?>/add_brand" class="btn blue dropdown-toggle"> <span> Add brand </span> </a> </li>
  ...
  <div class="col-md-12">
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Manage brand </a> </li>
      </ul>
        ...
        <div id="tab_1_5" >
          <div class="row search-form-default">
            <div class="col-md-12">
              ...
              <form class="form-inline" action="<?php echo base_url() . $this->router->class; ?>/manage_brand/" id="search">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php if ($val['status'] == '1') {?>
                    <span class="label label-sm label-success"> <a href="<?php echo base_url() . $this->router->class; ?>/enable_disable_brand/<?php echo $val['id']; ?>/0/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>" onclick="return dis_fun('<?php echo $item ?>');">Active</a> </span>
                    <?php } else { ?>
                    <span class="label label-sm label-success"> <a href="<?php echo base_url() . $this->router->class; ?>/enable_disable_brand/<?php echo $val['id']; ?>/1/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>" onclick="return enb_fun('<?php echo $item ?>');">Inactive</a> </span>
                    <?php } ?></td>
                  <td><!--<a class="javascript:void(0)" href="<?php echo base_url() . $this->router->class; ?>/view_brand/<?php echo $val['id']; ?>"> <i class="fa fa-search fonta"></i> </a>--> 
                    <a class="javascript:void(0)" href="<?php echo base_url() . $this->router->class; ?>/delete_brand/<?php echo $val['id']; ?>/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>" onclick="return archive_fun('<?php echo $item ?>');"><i class="fa fa-times fonta"></i></a> <a class="javascript:void(0)" href="<?php echo base_url() . $this->router->class; ?>/edit_brand/<?php echo $val['id']; ?>/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>"><i class="fa fa-edit fonta"></i></a></td>
                </tr>
                <?php
						}
					} else {
