  ...
  <div class="col-md-12"> 
    ...
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a href="#tab_1_1" data-toggle="tab"> Add category </a> </li>
      </ul>
        ...
        <div class="tab-pane active" id="tab_1_1">
          <div class="row">
            <div class="col-md-9">
              ...
              <form name="frm" id="validation_category" action="<?php echo base_url() .$this->router->class;?>/add_category_to_database" method="post">
                
				<?php if($do=="edit"){?>
                <input type="hidden" name="id" value="<?php echo !empty($categoryinfo['id']) ? $categoryinfo['id'] : "";?>">
                ...
                <div class="form-group flare">
                  ...
                  <div class="col-md-8">
                    <input class="form-control"  name="category_name" id="category_name" type="text" value="<?php echo !empty($categoryinfo['category_name']) ? $categoryinfo['category_name'] : "";?>"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    ...
                    <a href="<?php echo base_url().$this->router->class;?>/manage_category"  class="btn theme-btn grey pull-left margd">Cancel</a> </div>
                </div>
              </form>
            </div>
          </div>
