          ...
          <div class="row">
            <div class="col-md-9">
              ...
              <div class="form-group flare">
                ...
                <div class="col-md-8">
                  <input class="form-control" maxlength="220"  name="description1" id="description1" type="text" value="<?php echo !empty($bannerdata['description1']) ? $bannerdata['description1'] : "";?>"/>
                </div>
              </div>
			  ...
			  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <?php if($do=="edit"){ ?>
                      	<img src="<?php echo $this->config->item("slideshowimages").$bannerdata['image'];?>" height="100%" width="100%" />
