      ...
      <div class="tab-content"> 
        ...
        <div id="tab_1_5" >
          <div class="row search-form-default">
            <div class="col-md-12">
              <?php $search = urldecode($this->input->get("search")); ?>
              <form class="form-inline" action="<?php echo base_url().$this->router->class?>/manage_blog_comment/<?php echo $this->uri->segment(3)?>/" id="search">
               <input type="hidden" >
              ...
              <tbody>
				...
				<tr>
				  ...
				  <td><?php if($val['status'] == '1'){ ?>
                    <span class="label label-sm label-success"> <a href="<?php echo base_url().$this->router->class;?>/enable_disable_blog_comment/<?php echo $val['blogid'];?>/<?php echo $val["blog_comments_id"]?>/0/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>" onclick="return dis_fun('<?php echo $item?>');">Inactive</a> </span>
                    <?php }else{ ?>
                    <span class="label label-sm label-success"> <a href="<?php echo base_url().$this->router->class;?>/enable_disable_blog_comment/<?php echo $val['blogid'];?>/<?php echo $val["blog_comments_id"]?>/1/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>" onclick="return enb_fun('<?php echo $item?>');">Active</a> </span>
                    <?php } ?></td>
                     <td>
                     ...
                     <a class="javascript:void(0)" href="<?php echo base_url().$this->router->class;?>/archive_blog_comment/<?php echo $val['blogid'];?>/<?php echo $val['blog_comments_id'];?>/?per_page=<?php echo !empty($_GET['per_page']) ? $_GET['per_page'] : "";?>" onclick="return archive_fun('<?php echo $item?>');"><i class="fa fa-times fonta"></i></a> 
