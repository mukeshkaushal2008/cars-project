...
//for forget password
    ...
    public function validate_slideshow_data($slideshowarray = array()) {
        ...
        if ($slideshowarray["title"] == "") {
            ...
            $this->session->set_flashdata("errormsg", "Please enter description ");
            $err = 1;
    ...
    public function validate_home_content_data($slideshowarray = array()) {


        if ($slideshowarray["title"] == "") {
            $this->session->set_flashdata("errormsg", "Please enter title");
            $err = 1;
        } else if ($slideshowarray["description"] == "") {
            $this->session->set_flashdata("errormsg", "Please enter description ");
            $err = 1;
        } else if ($slideshowarray["image"] == "" && $slideshowarray["id"] == "") {
            $this->session->set_flashdata("errormsg", "Please select image");
    ...
    public function validate_home_partners_data($slideshowarray = array()) {

        if ($slideshowarray["image"] == "" && $slideshowarray["id"] == "") {
            $this->session->set_flashdata("errormsg", "Please select image");
            $err = 1;
        } else if (isset($slideshowarray["image"]) && $slideshowarray["image"] != "" && !in_array($this->common->get_extension($slideshowarray["image"]), $this->config->item("allowedimages"))) {
            $this->session->set_flashdata("errormsg", "File type is not valid");
    ...
    public function validate_our_partners_data($slideshowarray = array()) {

        if ($slideshowarray["title"] == "" && $slideshowarray["title"] == "") {
            $this->session->set_flashdata("errormsg", "Please enter title");
            $err = 1;
        }elseif ($slideshowarray["description"] == "" && $slideshowarray["description"] == "") {
            $this->session->set_flashdata("errormsg", "Please enter description");
            $err = 1;
        } elseif ($slideshowarray["image"] == "" && $slideshowarray["id"] == "") {
            $this->session->set_flashdata("errormsg", "Please select image");
            $err = 1;
        } else if (isset($slideshowarray["image"]) && $slideshowarray["image"] != "" && !in_array($this->common->get_extension($slideshowarray["image"]), $this->config->item("allowedimages"))) {
            $this->session->set_flashdata("errormsg", "File type is not valid");
