<div class="header navbar navbar-fixed-top"> 
    ...
    <div class="header-inner"> 
        ...
        <a class="navbar-brand" href="<?php echo base_url(); ?>"> <?php echo $this->config->item('sitename'); ?></a> 
...
<!--                        <li class="dropdown-submenu"> <a href="javascript:;"> Users Administration </a>
                        ...
                        <li class="dropdown-submenu"> <a href="javascript:;">Content Management </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li> <a href="<?php echo base_url(); ?>pages/manage_page/newsletter/">Newsletter</a> </li>

                                <li> <a href="<?php echo base_url(); ?>pages/manage_page/terms/edit/">Terms</a> </li>

                                <li> <a href="<?php echo base_url(); ?>pages/manage_page/privacy/edit/">Privacy</a> </li>

                               

                                <!--<li> <a href="<?php echo base_url(); ?>pages/manage_page/contact_us/">Contact Us</a> </li>-->
