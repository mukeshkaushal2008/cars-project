...
<link href="<?php echo base_url();?>js/selectdropdown/dist/css/bootstrap-select.css" rel="stylesheet">
<script type="text/javascript" src="<?php echo base_url();?>js/selectdropdown/dist/js/bootstrap-select.min.js"></script>
